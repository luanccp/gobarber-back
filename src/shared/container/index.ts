...
import UserTokensRepositoy from '@modules/users/infra/typeorm/repositories/UserTokensRepository';
...
container.registerSingleton<IUserTokensRepository>('UserTokensRepository', UserTokensRepositoy)
